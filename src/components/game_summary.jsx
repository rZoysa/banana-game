...
function Game_summary({ restartGame, onClose, score, difficulty }) {
  ...
  return (
    ...
    <div className="bg-black fixed flex justify-center items-center w-screen h-screen bg-opacity-45 select-none z-50">
      <motion.div
        className="bg-yellow-100 p-8 rounded-lg shadow-lg z-50 w-2/5 h-3/5"
      ...
      >
        ...
        src="summary.gif" 
        alt="Summary GIF"
        className="absolute bottom-64 w-100 h-100 left-1/2 transform -translate-x-1/2 opacity-90"
      />
        ...
        <div className="flex justify-center items-center">
          <div className="flex justify-between w-2/4">
            <button
              className="mt-4 px-4 py-2 bg-red-500 text-white rounded-lg hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-600"
              onClick={playAgain}
            >
              Play Again
            </button>
