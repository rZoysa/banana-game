    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      ...
      >
        <div className="bg-white p-4 rounded-lg relative w-fit h-3/6">
          <button className="absolute top-4 right-4 m-2" onClick={onClose}>
            <svg
          ...
          {userProfile && (
            <div className="font-itim text-3xl bg-amber-100 p-2 rounded-md">
              <u>
                ...
                {editMode ? (
                  <>
                    <img
                      src="Profile.png"
                      alt=""
                      className="select-none absolute bottom-4 -right-5 w-60  "
                    />
                    <input
                      type="text"
                      ...
                      className="border rounded-md p-1 mb-2 shadow-md border-solid border-gray-300 bg-red-300"
                    />
                    {usernameExistsError && (
              ...
              <div className="select-none">
                ...
                <p className="inline-flex justify-center items-center">
                  ...
                  />
                  Banana Blitz: {userProfile.medium}
                </p>
                <br />
                <p className="inline-flex justify-center items-center">
                  <img
                    ...
                    className="w-7 h-7 mr-2"
                  />
                  Banana Frenzy: {userProfile.hard}
                </p>
                <br />
              </div>
                ...
                <div className="w-full flex flex-row justify-center">
                  ...
                  >
                    <button
                      ...
                      className="bg-emerald-600 text-white px-4 py-2 rounded-md my-4 w-fit"
                    >
                      Edit Profile
                    </button>
                  </motion.div>
                ...
                <div className="inline-flex">
                  ...
                  >
                    <button
                      ...
                      className="bg-emerald-600 text-white px-4 py-2 rounded-md mt-4 mr-4"
                    >
                      Save
                    </button>
                  </motion.div>
